...
function loadBoard(fun: Function) {
            ...
            moves.forEach((id, index) => {
                if (id == 2 && board[index] != 0) {
                    ...
                    if (id == 2) {
                        ...
                        const indicators =
                            squares[index].getElementsByClassName('indicator')
...
function generatePiece(id: number, index: number): HTMLImageElement {
    const image = document.createElement('img')
    ...
    loadBoard(() => {
        ...
        board.forEach((id, index) => {
            ...
            if (id == 0) {
                ...
                let image: Element | null =
                    square.getElementsByClassName('piece')[0]
